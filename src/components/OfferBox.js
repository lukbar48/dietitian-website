        ...
        <div className={styles.box}>
          ...
          <div className={styles.offer}>
            <ul>
              ...
              <li>Lorem ipsum dolor sit.</li>
              <li>Enim, accusantium! Eius, aliquam.</li>
              <li>Animi soluta nihil suscipit atque, dolorum in illum itaque omnis rem mollitia hic non cum autem necessitatibus.</li>
            </ul>
          </div>
          <div className={styles.footer}>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.offer}>
            <ul>
              ...
              <li>Lorem ipsum dolor sit.</li>
              <li>Enim, accusantium! Eius, aliquam.</li>
              <li>Repellat sed animi amet eos, libero eveniet excepturi soluta quos reiciendis sint.</li>
              <li>Modi minus quaerat provident nobis ad soluta consequatur totam error, sed perferendis.</li>
            </ul>
          </div>
          <div className={styles.footer}>
            <Button color>Wybieram pakiet</Button>
